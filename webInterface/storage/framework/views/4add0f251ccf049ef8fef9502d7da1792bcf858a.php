                ...
                <?php if(!Auth::guest()): ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo e(url('/database')); ?>">Database Test</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            <span class="glyphicon glyphicon-user" aria-hidden="true"></span> <?php echo e(Auth::user()->name); ?> <span class="caret"></span>
                        </a>
